...
class NavBar extends React.Component {
    render() {
        ...
        const workexperienceClass = location.pathname === '/work experience' ? 'active-item' : '';
        const skillsClass = location.pathname === '/skills' ? 'active-item' : '';
        const licensesClass = location.pathname === '/Licenses' ? 'active-item' : '';
        ...
        return (
            <Menu>
                ...
                <Link to="/work experience" className={`menu-item ${workexperienceClass}`}>
                    WorkExperience
                </Link>
                <Link to="/skills" className={`menu-item ${skillsClass}`}>
                    Skills
                </Link>
                <Link to="/Licenses and Certifications" className={`menu-item ${licensesClass}`}>
                    Licenses
                </Link>
